...
const Auth = () => {
    ...
    try {
      ...
      if (err instanceof z.ZodError) {
        ...
        err.errors.forEach(e => {
          ...
          else fieldErrors['login_email'] = e.message;
        });
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof z.ZodError) {
        ...
        err.errors.forEach(e => {
          ...
          else fieldErrors['signup_email'] = e.message;
        });
        setErrors(fieldErrors);
        return;
      }
    ...
    if (error) {
      ...
      toast.success('Account created! Welcome to Airlytics.');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-accent/20 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-3xl font-bold text-foreground">Airlytics</span>
        </div>
        ...
        <Card className="shadow-lg border-border/50">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              Sign in to track air quality and get personalized alerts
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* Google Sign In */}
